    ...
    1: [function(e, t) {
        (function(n) {
            ...
            t.exports = function(e, t, l, u) {
                ...
                function h() {
                    d(new a(l._generateID)), k.getMarketingCloudVisitorID(), k.callbackRegistry.executeAll(k.state, !0), n.removeEventListener("message", v)
                }

                function v(e) {
                    if (!S.isInvalid(e)) {
                        var t = S.parse(e);
                        D = !1, n.clearTimeout(this.timeout), n.removeEventListener("message", v), d(new i(k)), n.addEventListener("message", f), k.setStateAndPublish(t.state), k.callbackRegistry.hasCallbacks() && g(c.GETSTATE)
                    }
                }

                function m() {
                    b && postMessage ? (n.addEventListener("message", v), g(c.HANDSHAKE), this.timeout = setTimeout(h, 250)) : h()
                }
                ...
                function y() {
                    function e(e) {
                        0 !== e.indexOf("_") && "function" == typeof l[e] && (k[e] = function() {})
                    }
                    Object.keys(l).forEach(e), k.getSupplementalDataID = l.getSupplementalDataID
                }
                var k = this,
                    b = t.whitelistParentDomain;
                k.state = {}, k.version = l.version, k.marketingCloudOrgID = e;
                var D = !1,
                    S = new o(e, b);
                k.callbackRegistry = s(), k.findField = function(e, t) {
                    if (k.state[e]) return t(k.state[e]), k.state[e]
                }, k.messageParent = g, k.setStateAndPublish = p, _(), y(), d(new r(k)), m()
            }
                ...
                l = function(e, t) {
                    ...
                    var w = {
                            ...
                            fireCORS: function(e, t) {
                                ...
                                try {
                                    ...
                                    i.open("get.html", e.corsUrl + "&ts=" + (new Date).getTime(), !0), "XMLHttpRequest" === this.corsMetadata.corsType && (i.withCredentials = !0, i.timeout = _.loadTimeout, i.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), i.onreadystatechange = function() {
                    ...
                    var N = {
                        ...
                        getIframeHost: function(e) {
                            if ("string" == typeof e) {
                                var t = e.split("https://www.elsevier.com/");
                                return t[0] + "//" + t[2]
                            }
                        },
                        subdomain: null,
                            ...
                            if (e) {
                                if ("img" === t.tag) {
                                    ...
                                    for (o = 0, c = d.length; o < c; o++) {
                                        l = d[o], u = /^\/\//.test(l);
                                        var f = new Image;
                                        F.addListener(f, "load", function(e, t, n, a) {
                                            return function() {
                                        ...
                                        }(this.onPagePixels.length, t, i, r)), f.src = (u ? p : "") + l, this.onPagePixels.push(f)
                                    }
                                }
...
function(e, t, n) {
    function a() {
        var e = V.filter(V.rules, function(e) {
            return 0 === e.event.indexOf("dataelementchange")
        });
        this.dataElementsNames = V.map(e, function(e) {
            return e.event.match(/dataelementchange\((.*)\)/i)[1]
        }, this), this.initPolling()
    }

    function i() {
        V.addEventHandler(e, "orientationchange", i.orientationChange)
    }
    ...
    function r() {
        ...
        V.bindEvent("aftertoolinit", function() {
            V.fireEvent(V.visibility.isHidden() ? "tabblur" : "tabfocus")
        })
    }

    function s() {
        this.rules = V.filter(V.rules, function(e) {
    ...
    function o() {
        ...
        }), this.eventHandler = V.bind(this.onUpdateTime, this)
    }

    function c(t) {
        t = t || V.rules, this.rules = V.filter(t, function(e) {
            return "inview" === e.event
        }), this.elements = [], this.eventHandler = V.bind(this.track, this), V.addEventHandler(e, "scroll", this.eventHandler), V.addEventHandler(e, "load", this.eventHandler)
    }

    function l() {
        V.getToolsByType("nielsen").length > 0 && V.domReady(V.bind(this.initialize, this))
    }

    function u() {
        var e = this.eventRegex = /^hover\(([0-9]+)\)$/,
            t = this.rules = [];
        V.each(V.rules, function(n) {
            n.event.match(e) && t.push([Number(n.event.match(e)[1]), n.selector])
        })
    }

    function d(e) {
        this.delay = 250, this.FB = e, V.domReady(V.bind(function() {
            V.poll(V.bind(this.initialize, this), this.delay, 8)
        }, this))
    }

    function p(t) {
        V.domReady(V.bind(function() {
            this.twttr = t || e.twttr, this.initialize()
        }, this))
    }

    function f() {
        this.lastURL = V.URL(), this._fireIfURIChanged = V.bind(this.fireIfURIChanged, this), this._onPopState = V.bind(this.onPopState, this), this._onHashChange = V.bind(this.onHashChange, this), this._pushState = V.bind(this.pushState, this), this._replaceState = V.bind(this.replaceState, this), this.initialize()
    }

    function g(e) {
        V.BaseTool.call(this, e), this.defineListeners(), this.beaconMethod = "plainBeacon", this.adapt = new g.DataAdapters, this.dataProvider = new g.DataProvider.Aggregate
    }

    function h(e) {
        V.BaseTool.call(this, e), this.name = e.name || "VisitorID", this.initialize()
    }

    function v(e) {
        V.BaseTool.call(this, e), this.varBindings = {}, this.events = [], this.products = [], this.customSetupFuns = []
    }

    function m() {
        V.BaseTool.call(this), this.asyncScriptCallbackQueue = [], this.argsForBlockingScripts = []
    }

    function _(e) {
        V.BaseTool.call(this, e), this.styleElements = {}, this.targetPageParamsStore = {}
    }

    function y(e) {
        V.BaseTool.call(this, e), this.name = e.name || "Basic"
    }

    function k(e) {
        V.BaseTool.call(this, e)
    }

    function b(e) {
        V.BaseTool.call(this, e)
    }
    var D, S, C, T = Object.prototype.toString,
        E = e._satellite && e._satellite.override,
        V = {
            initialized: !1,
            $data: function(e, t, a) {
                if (e) {
            ...
            isObject: function(e) {
                return null != e && !V.isArray(e) && "object" == typeof e
            },
            isString: function(e) {
                return "string" == typeof e
            },
            isNumber: function(e) {
                return "[object Number]" === T.apply(e) && !V.isNaN(e)
            },
            isNaN: function(e) {
                return e != e
            },
            ...
            stringify: function(e, t) {
                if (t = t || [], V.isObject(e)) {
                    if (V.contains(t, e)) return "<Cycle>";
                    t.push(e)
                }
                if (V.isArray(e)) return "[" + V.map(e, function(e) {
                    return V.stringify(e, t)
                }).join(",") + "]";
                if (V.isString(e)) return '"' + String(e) + '"';
                if (V.isObject(e)) {
                    var n = [];
                    for (var a in e) e.hasOwnProperty(a) && n.push(a + ": " + V.stringify(e[a], t));
                    return "{" + n.join(", ") + "}"
                }
                return String(e)
            },
            ...
            loadScript: function(e, n) {
                ...
                V.scriptOnLoad(e, a, n), a.src = e, t.getElementsByTagName("head")[0].appendChild(a)
            },
            scriptOnLoad: function(e, t, n) {
                function a(e) {
                    e && V.logError(e), n && n(e)
                }
            ...
            loadScriptOnce: function(e, t) {
                V.loadedScriptRegistry[e] || V.loadScript(e, function(n) {
                    n || (V.loadedScriptRegistry[e] = !0), t && t(n)
                })
            },
            loadedScriptRegistry: {},
            loadScriptSync: function(e) {
                t.write ? V.domReadyFired ? V.notify('Cannot load sync the "' + e + '" script after DOM Ready.', 1) : (e.indexOf('"') > -1 && (e = encodeURI(e)), t.write('<script src="' + e + '"></script>')) : V.notify('Cannot load sync the "' + e + '" script because "document.write" is not available', 1)
            },
            pushAsyncScript: function(e) {
                V.tools["default"].pushAsyncScript(e)
            },
            pushBlockingScript: function(e) {
                V.tools["default"].pushBlockingScript(e)
            },
            ...
            matchesCss: function(n) {
                ...
                return i ? function(n, a) {
                    ...
                    if (e.match(/^[a-z]+$/i)) return a(e, t);
                    try {
                        return V.Sizzle.matches(e, [t]).length > 0
                    } catch (n) {
                        return !1
                    }
                }
            ...
            poll: function(e, t, n) {
                function a() {
                    V.isNumber(n) && i++ >= n || e() || setTimeout(a, t)
                }
                var i = 0;
                t = t || 1e3, a()
            },
    ...
    V.availableTools = {}, V.availableEventEmitters = [], V.fireOnceEvents = ["condition", "elementexists"], V.initEventEmitters = function() {
        V.eventEmitters = V.map(V.availableEventEmitters, function(e) {
            return new e
        })
    }, V.eventEmitterBackgroundTasks = function() {
        V.each(V.eventEmitters, function(e) {
            "backgroundTasks" in e && e.backgroundTasks()
        })
    }, V.initTools = function(e) {
        var t = {
                "default": new m
            },
            n = V.settings.euCookieName || "sat_track";
        for (var a in e)
            if (e.hasOwnProperty(a)) {
                var i, r, s;
                if ((i = e[a]).euCookie)
                    if ("true" !== V.readCookie(n)) continue;
                if (!(r = V.availableTools[i.engine])) {
                    var o = [];
                    for (var c in V.availableTools) V.availableTools.hasOwnProperty(c) && o.push(c);
                    throw new Error("No tool engine named " + i.engine + ", available: " + o.join(",") + ".")
                }(s = new r(i)).id = a, t[a] = s
            } return t
    }, V.preprocessArguments = function(e, t, n, a, i) {
        function r(e) {
            return a && V.isString(e) ? e.toLowerCase() : e
        }
        ...
        function s(e) {
            ...
            for (var l in e)
                if (e.hasOwnProperty(l)) {
                    var u = e[l];
                    V.isObject(u) ? c[l] = s(u) : V.isArray(u) ? c[l] = o(u, a) : c[l] = r(V.replace(u, t, n, i))
                } return c
        }
        ...
        function o(e) {
            for (var a = [], i = 0, o = e.length; i < o; i++) {
                var c = e[i];
                V.isString(c) ? c = r(V.replace(c, t, n)) : c && c.constructor === Object && (c = s(c)), a.push(c)
            }
            return a
        }
        return e ? o(e, a) : e
    }, V.execute = function(e, t, n, a) {
        function i(i) {
            var r = a[i || "default"];
            if (r) try {
        ...
        if (!_satellite.settings.hideActivity)
            ...
            } else e.tool instanceof Array ? V.each(e.tool, function(e) {
                i(e)
            }) : i(e.tool)
    }, V.Logger = {
        outputEnabled: !1,
        ...
        flush: function() {
            this.flushed || (V.each(this.messages, function(e) {
                !0 !== e[2] && (this.echo(e[0], e[1]), e[2] = !0)
            }, this), this.flushed = !0)
        }
    }, V.notify = V.bind(V.Logger.message, V.Logger), V.cleanText = function(e) {
        return null == e ? null : V.trim(e).replace(/\s+/g, " ")
    }, V.cleanText.legacy = function(e) {
        return null == e ? null : V.trim(e).replace(/\s{2,}/g, " ").replace(/[^\000-\177]*/g, "")
    }, V.text = function(e) {
        return e.textContent || e.innerText
    }, V.specialProperties = {
        text: V.text,
        cleanText: function(e) {
            return V.cleanText(V.text(e))
        }
    }, V.getObjectProperty = function(e, t, a) {
        for (var i, r = t.split("."), s = e, o = V.specialProperties, c = 0, l = r.length; c < l; c++) {
            if (null == s) return n;
            var u = r[c];
        ...
        return s
    }, V.getToolsByType = function(e) {
        if (!e) throw new Error("Tool type is missing");
        var t = [];
        for (var n in V.tools)
            if (V.tools.hasOwnProperty(n)) {
                var a = V.tools[n];
                a.settings && a.settings.engine === e && t.push(a)
            } return t
    }, V.setVar = function() {
        var e = V.data.customVars;
        if (null == e && (V.data.customVars = {}, e = V.data.customVars), "string" == typeof arguments[0]) e[arguments[0]] = arguments[1];
        else if (arguments[0]) {
            var t = arguments[0];
            for (var n in t) t.hasOwnProperty(n) && (e[n] = t[n])
        }
    }, V.dataElementSafe = function(e, t) {
        if (arguments.length > 2) {
            var n = arguments[2];
            "pageview" === t ? V.dataElementSafe.pageviewCache[e] = n : "session" === t ? V.setCookie("_sdsat_" + e, n) : "visitor" === t && V.setCookie("_sdsat_" + e, n, 730)
        } else {
            if ("pageview" === t) return V.dataElementSafe.pageviewCache[e];
            if ("session" === t || "visitor" === t) return V.readCookie("_sdsat_" + e)
        }
    }, V.dataElementSafe.pageviewCache = {}, V.realGetDataElement = function(t) {
        var n;
        return t.selector ? V.hasSelector && V.cssQuery(t.selector, function(e) {
            if (e.length > 0) {
                var a = e[0];
                "text" === t.property ? n = a.innerText || a.textContent : t.property in a ? n = a[t.property] : V.hasAttr(a, t.property) && (n = a.getAttribute(t.property))
            }
        }) : t.queryParam ? n = t.ignoreCase ? V.getQueryParamCaseInsensitive(t.queryParam) : V.getQueryParam(t.queryParam) : t.cookie ? n = V.readCookie(t.cookie) : t.jsVariable ? n = V.getObjectProperty(e, t.jsVariable) : t.customJS ? n = t.customJS() : t.contextHub && (n = t.contextHub()), V.isString(n) && t.cleanText && (n = V.cleanText(n)), n
    }, V.getDataElement = function(e, t, a) {
        if (null == (a = a || V.dataElements[e])) return V.settings.undefinedVarsReturnEmpty ? "" : null;
        var i = V.realGetDataElement(a);
        return i === n && a.storeLength ? i = V.dataElementSafe(e, a.storeLength) : i !== n && a.storeLength && V.dataElementSafe(e, a.storeLength, i), i || t || (i = a["default"] || ""), V.isString(i) && a.forceLowerCase && (i = i.toLowerCase()), i
    }, V.getVar = function(a, i, r) {
        var s, o, c = V.data.customVars,
        ...
        if (V.dataElements && a in V.dataElements) return V.getDataElement(a);
        if ((o = u[a.toLowerCase()]) === n)
            if ("this." === a.substring(0, 5)) a = a.slice(5), o = V.getObjectProperty(i, a, !0);
            else if ("event." === a.substring(0, 6)) a = a.slice(6), o = V.getObjectProperty(r, a);
        else if ("target." === a.substring(0, 7)) a = a.slice(7), o = V.getObjectProperty(l, a);
        else if ("window." === a.substring(0, 7)) a = a.slice(7), o = V.getObjectProperty(e, a);
        else if ("param." === a.substring(0, 6)) a = a.slice(6), o = V.getQueryParam(a);
        else if (s = a.match(/^rand([0-9]+)$/)) {
            var d = Number(s[1]),
                p = (Math.random() * (Math.pow(10, d) - 1)).toFixed(0);
            o = Array(d - p.length + 1).join("0") + p
        } else o = V.getObjectProperty(c, a);
        return o
    }, V.getVars = function(e, t, n) {
        var a = {};
        return V.each(e, function(e) {
            a[e] = V.getVar(e, t, n)
        }), a
    }, V.replace = function(e, t, n, a) {
        return "string" != typeof e ? e : e.replace(/%(.*?)%/g, function(e, i) {
            var r = V.getVar(i, t, n);
            return null == r ? V.settings.undefinedVarsReturnEmpty ? "" : e : a ? V.escapeForHtml(r) : r
        })
    }, V.escapeHtmlParams = function(e) {
        return e.escapeHtml = !0, e
    }, V.searchVariables = function(e, t, n) {
        ...
        if (a) {
            ...
            V.contains(V.fireOnceEvents, e.event) && (e.expired = !0)
        }
    }, V.isLinked = function(e) {
        for (var t = e; t; t = t.parentNode)
            if (V.isLinkTag(t)) return !0;
        return !1
    }, V.firePageLoadEvent = function(e) {
        for (var n = t.location, a = {
                type: e,
                target: n
            }, i = V.pageLoadRules, r = V.evtHandlers[a.type], s = i.length; s--;) {
            var o = i[s];
            V.ruleMatches(o, a, n) && (V.notify('Rule "' + o.name + '" fired.', 1), V.fireRule(o, n, a))
        }
        for (var c in V.tools)
            if (V.tools.hasOwnProperty(c)) {
                var l = V.tools[c];
                l.endPLPhase && l.endPLPhase(e)
            } r && V.each(r, function(e) {
            e(a)
        })
    }, V.track = function(e) {
        e = e.replace(/^\s*/, "").replace(/\s*$/, "");
        for (var t = 0; t < V.directCallRules.length; t++) {
            var n = V.directCallRules[t];
            if (n.name === e) return V.notify('Direct call Rule "' + e + '" fired.', 1), void V.fireRule(n, location, {
                type: e
            })
        }
        V.notify('Direct call Rule "' + e + '" not found.', 1)
    }, V.basePath = function() {
        return V.data.host ? ("https:" === t.location.protocol ? "https://" + V.data.host.https : "http://" + V.data.host.http) + "/" : this.settings.basePath
    }, V.setLocation = function(t) {
        e.location = t
    }, V.parseQueryParams = function(e) {
        var t = function(e) {
            var t = e;
            try {
    ...
    }, V.getCaseSensitivityQueryParamsMap = function(e) {
        var t = V.parseQueryParams(e),
            n = {};
    ...
    }, V.updateQueryParams = function() {
        V.QueryParams = V.getCaseSensitivityQueryParamsMap(e.location.search)
    }, V.updateQueryParams(), V.getQueryParam = function(e) {
        return V.QueryParams.normal[e]
    }, V.getQueryParamCaseInsensitive = function(e) {
        return V.QueryParams.caseInsensitive[e.toLowerCase()]
    }, V.encodeObjectToURI = function(e) {
        if (!1 === V.isObject(e)) return "";
        var t = [];
        for (var n in e) e.hasOwnProperty(n) && t.push(encodeURIComponent(n) + "=" + encodeURIComponent(e[n]));
        return t.join("&")
    }, V.readCookie = function(e) {
        ...
        V.setCookie(e, "", -1)
    }, V.getElementProperty = function(e, t) {
        if ("@" === t.charAt(0)) {
            var a = V.specialProperties[t.substring(1)];
            if (a) return a(e)
        }
        return "innerText" === t ? V.text(e) : t in e ? e[t] : e.getAttribute ? e.getAttribute(t) : n
    }, V.propertiesMatch = function(e, t) {
        if (e)
            for (var n in e)
                if (e.hasOwnProperty(n)) {
                    var a = e[n],
                        i = V.getElementProperty(t, n);
                    if ("string" == typeof a && a !== i) return !1;
                    if (a instanceof RegExp && !a.test(i)) return !1
                } return !0
    }, V.isRightClick = function(e) {
        var t;
        return e.which ? t = 3 == e.which : e.button && (t = 2 == e.button), t
    }, V.ruleMatches = function(e, t, n, a) {
        var i = e.condition,
            r = e.conditions,
            s = e.property,
            o = t.type,
        ...
        if (!V.ruleInScope(e)) return !1;
        if ("click" === e.event && V.isRightClick(t)) return !1;
        ...
        if (e.selector && !V.matchesCss(e.selector, n)) return !1;
        if (!V.propertiesMatch(s, n)) return !1;
        if (null != c)
            if ("string" == typeof c) {
                if (c !== n.value) return !1
            } else if (!c.test(n.value)) return !1;
        if (i) try {
            if (!i.call(n, t, l)) return V.notify('Condition for rule "' + e.name + '" not met.', 1), !1
        } catch (p) {
            return V.notify('Condition for rule "' + e.name + '" not met. Error: ' + p.message, 1), !1
        }
        if (r) {
            var d = V.find(r, function(a) {
                try {
                    return !a.call(n, t, l)
                } catch (p) {
                    return V.notify('Condition for rule "' + e.name + '" not met. Error: ' + p.message, 1), !0
                }
            });
            if (d) return V.notify("Condition " + d.toString() + ' for rule "' + e.name + '" not met.', 1), !1
        }
        return !0
    }, V.evtHandlers = {}, V.bindEvent = function(e, t) {
        var n = V.evtHandlers;
        n[e] || (n[e] = []), n[e].push(t)
    }, V.whenEvent = V.bindEvent, V.unbindEvent = function(e, t) {
        var n = V.evtHandlers;
        if (n[e]) {
            var a = V.indexOf(n[e], t);
            n[e].splice(a, 1)
        }
    }, V.bindEventOnce = function(e, t) {
        var n = function() {
            V.unbindEvent(e, n), t.apply(null, arguments)
        };
        V.bindEvent(e, n)
    }, V.isVMLPoisoned = function(e) {
        if (!e) return !1;
        try {
            e.nodeName
        } catch (t) {
        ...
        return !1
    }, V.handleEvent = function(e) {
        if (!V.$data(e, "eventProcessed")) {
            var t = e.type.toLowerCase(),
                n = e.target || e.srcElement,
                a = 0,
                i = V.rules,
                r = (V.tools, V.evtHandlers[e.type]);
            if (V.isVMLPoisoned(n)) V.notify("detected " + t + " on poisoned VML element, skipping.", 1);
            else {
                r && V.each(r, function(t) {
                    t(e)
                }), n && n.nodeName ? V.notify("detected " + t + " on " + n.nodeName, 1) : V.notify("detected " + t, 1);
                for (var s = n; s; s = s.parentNode) {
                    var o = !1;
                    if (V.each(i, function(t) {
                            V.ruleMatches(t, e, s, a) && (V.notify('Rule "' + t.name + '" fired.', 1), V.fireRule(t, s, e), a++, t.bubbleStop && (o = !0))
                        }), o) break
                }
                V.$data(e, "eventProcessed", !0)
            }
        }
    }, V.onEvent = t.querySelectorAll ? function(e) {
        V.handleEvent(e)
    } : (S = [], (C = function(e) {
        e.selector ? S.push(e) : V.handleEvent(e)
    }).pendingEvents = S, C), V.fireEvent = function(e, t) {
        V.onEvent({
            type: e,
            target: t
        })
    }, V.registerEvents = function(e, t) {
        for (var n = t.length - 1; n >= 0; n--) {
            var a = t[n];
            V.$data(e, a + ".tracked") || (V.addEventHandler(e, a, V.onEvent), V.$data(e, a + ".tracked", !0))
        }
    }, V.registerEventsForTags = function(e, n) {
        for (var a = e.length - 1; a >= 0; a--)
            for (var i = e[a], r = t.getElementsByTagName(i), s = r.length - 1; s >= 0; s--) V.registerEvents(r[s], n)
    }, V.setListeners = function() {
        var e = ["click", "submit"];
        V.each(V.rules, function(t) {
            "custom" === t.event && t.hasOwnProperty("customEvent") && !V.contains(e, t.customEvent) && e.push(t.customEvent)
        }), V.registerEvents(t, e)
    }, V.getUniqueRuleEvents = function() {
        return V._uniqueRuleEvents || (V._uniqueRuleEvents = [], V.each(V.rules, function(e) {
            -1 === V.indexOf(V._uniqueRuleEvents, e.event) && V._uniqueRuleEvents.push(e.event)
        })), V._uniqueRuleEvents
    }, V.setFormListeners = function() {
        if (!V._relevantFormEvents) {
            var e = ["change", "focus", "blur", "keypress"];
            V._relevantFormEvents = V.filter(V.getUniqueRuleEvents(), function(t) {
                return -1 !== V.indexOf(e, t)
            })
        }
        V._relevantFormEvents.length && V.registerEventsForTags(["input", "select", "textarea", "button"], V._relevantFormEvents)
    }, V.setVideoListeners = function() {
        if (!V._relevantVideoEvents) {
            var e = ["play", "pause", "ended", "volumechange", "stalled", "loadeddata"];
            V._relevantVideoEvents = V.filter(V.getUniqueRuleEvents(), function(t) {
                return -1 !== V.indexOf(e, t)
            })
        }
        V._relevantVideoEvents.length && V.registerEventsForTags(["video"], V._relevantVideoEvents)
    }, V.readStoredSetting = function(t) {
        try {
            return t = "sdsat_" + t, e.localStorage.getItem(t)
        } catch (n) {
            return V.notify("Cannot read stored setting from localStorage: " + n.message, 2), null
        }
    }, V.loadStoredSettings = function() {
        var e = V.readStoredSetting("debug"),
            t = V.readStoredSetting("hide_activity");
        e && (V.settings.notifications = "true" === e), t && (V.settings.hideActivity = "true" === t)
    }, V.isRuleActive = function(e, t) {
        function n(e, t) {
            return t = i(t, {
                hour: e[f](),
                minute: e[g]()
        ...
        if (t = t || new Date, o.repeat) {
            ...
            if ("daily" === o.repeat) {
                ...
                if (o.days) {
                    if (!V.contains(o.days, t[u]())) return !1
        ...
        return !0
    }, V.isOutboundLink = function(e) {
        if (!e.getAttribute("href")) return !1;
        var t = e.hostname,
            n = (e.href, e.protocol);
        return ("http:" === n || "https:" === n) && (!V.any(V.settings.domainList, function(e) {
            return V.isSubdomainOf(t, e)
        }) && t !== location.hostname)
    }, V.isLinkerLink = function(e) {
        return !(!e.getAttribute || !e.getAttribute("href")) && (V.hasMultipleDomains() && e.hostname != location.hostname && !e.href.match(/^javascript/i) && !V.isOutboundLink(e))
    }, V.isSubdomainOf = function(e, t) {
        if (e === t) return !0;
        var n = e.length - t.length;
        return n > 0 && V.equalsIgnoreCase(e.substring(n), t)
    }, V.getVisitorId = function() {
        var e = V.getToolsByType("visitor_id");
        return 0 === e.length ? null : e[0].getInstance()
    }, V.URI = function() {
        var e = t.location.pathname + t.location.search;
        return V.settings.forceLowerCase && (e = e.toLowerCase()), e
    }, V.URL = function() {
        var e = t.location.href;
        return V.settings.forceLowerCase && (e = e.toLowerCase()), e
    }, V.filterRules = function() {
        function e(e) {
            return !!V.isRuleActive(e)
        }
        V.rules = V.filter(V.rules, e), V.pageLoadRules = V.filter(V.pageLoadRules, e)
    }, V.ruleInScope = function(e, n) {
        function a(e, t) {
            function n(e) {
                return t.match(e)
            }
            ...
            if (a && i(a, t)) return !0;
            if (r) {
                if (V.isString(r) && r === t) return !0;
                if (V.isArray(r) && V.any(r, n)) return !0;
                if (V.isRegex(r) && n(r)) return !0
            }
            return !1
        }
        ...
        function i(e, t) {
            ...
            return !(!V.isString(e) || e === t) || (!(!V.isArray(e) || V.any(e, n)) || !(!V.isRegex(e) || n(e)))
        }
        n = n || t.location;
        var r = e.scope;
        if (!r) return !0;
    ...
    }, V.backgroundTasks = function() {
        new Date;
        V.setFormListeners(), V.setVideoListeners(), V.loadStoredSettings(), V.registerNewElementsForDynamicRules(), V.eventEmitterBackgroundTasks();
        new Date
    }, V.registerNewElementsForDynamicRules = function() {
        function e(t, n) {
            var a = e.cache[t];
            if (a) return n(a);
            V.cssQuery(t, function(a) {
                e.cache[t] = a, n(a)
            })
        }
        e.cache = {}, V.each(V.dynamicRules, function(t) {
            e(t.selector, function(e) {
                V.each(e, function(e) {
                    var n = "custom" === t.event ? t.customEvent : t.event;
                    V.$data(e, "dynamicRules.seen." + n) || (V.$data(e, "dynamicRules.seen." + n, !0), V.propertiesMatch(t.property, e) && V.registerEvents(e, [n]))
                })
            })
        })
    }, V.ensureCSSSelector = function() {
        t.querySelectorAll ? V.hasSelector = !0 : (V.loadingSizzle = !0, V.sizzleQueue = [], V.loadScript(V.basePath() + "selector.js", function() {
            if (V.Sizzle) {
                var e = V.onEvent.pendingEvents;
                V.each(e, function(e) {
                    V.handleEvent(e)
                }, this), V.onEvent = V.handleEvent, V.hasSelector = !0, delete V.loadingSizzle, V.each(V.sizzleQueue, function(e) {
                    V.cssQuery(e[0], e[1])
                }), delete V.sizzleQueue
            } else V.logError(new Error("Failed to load selector.js"))
        }))
    }, V.errors = [], V.logError = function(e) {
        V.errors.push(e), V.notify(e.name + " - " + e.message, 5)
    }, V.pageBottom = function() {
        V.initialized && (V.pageBottomFired = !0, V.firePageLoadEvent("pagebottom"))
    }, V.stagingLibraryOverride = function() {
        if ("true" === V.readStoredSetting("stagingLibrary")) {
        ...
        return !1
    }, V.checkAsyncInclude = function() {
        e.satellite_asyncLoad && V.notify('You may be using the async installation of Satellite. In-page HTML and the "pagebottom" event will not work. Please update your Satellite installation for these features.', 5)
    }, V.hasMultipleDomains = function() {
        return !!V.settings.domainList && V.settings.domainList.length > 1
    }, V.handleOverrides = function() {
        if (E)
            for (var e in E) E.hasOwnProperty(e) && (V.data[e] = E[e])
    }, V.privacyManagerParams = function() {
        var e = {};
        V.extend(e, V.settings.privacyManagement);
        var t = [];
        for (var n in V.tools)
            if (V.tools.hasOwnProperty(n)) {
                var a = V.tools[n],
            ...
            } var r = V.filter(V.map(t, function(e) {
        ...
        for (var s = ["bannerText", "headline", "introductoryText", "customCSS"], o = 0; o < s.length; o++) {
            ...
            if (l)
                if ("text" === l.type) e[c] = l.value;
                    ...
                    e[c] = V.getVar(l.value)
                }
        }
        return e
    }, V.prepareLoadPrivacyManager = function() {
        function t(e) {
            function t() {
            ...
            var i = V.filter(V.values(V.tools), function(e) {
                return e.settings && "sc" === e.settings.engine
            });
            if (0 === i.length) return e();
            var r = 0;
            V.each(i, function(e) {
                V.bindEvent(e.id + ".load", t)
            });
            var s = setTimeout(a, 5e3)
        }
        V.addEventHandler(e, "load", function() {
            t(V.loadPrivacyManager)
        })
    }, V.loadPrivacyManager = function() {
        var e = V.basePath() + "privacy_manager.js";
        V.loadScript(e, function() {
            var e = V.privacyManager;
            e.configure(V.privacyManagerParams()), e.openIfRequired()
        })
    }, V.init = function(t) {
        if (!V.stagingLibraryOverride()) {
            V.configurationSettings = t;
            var a = t.tools;
            for (var i in delete t.tools, t) t.hasOwnProperty(i) && (V[i] = t[i]);
            V.data.customVars === n && (V.data.customVars = {}), V.data.queryParams = V.QueryParams.normal, V.handleOverrides(), V.detectBrowserInfo(), V.trackVisitorInfo && V.trackVisitorInfo(), V.loadStoredSettings(), V.Logger.setOutputState(V.settings.notifications), V.checkAsyncInclude(), V.ensureCSSSelector(), V.filterRules(), V.dynamicRules = V.filter(V.rules, function(e) {
                return e.eventHandlerOnElement
            }), V.tools = V.initTools(a), V.initEventEmitters(), V.firePageLoadEvent("aftertoolinit"), V.settings.privacyManagement && V.prepareLoadPrivacyManager(), V.hasSelector && V.domReady(V.eventEmitterBackgroundTasks), V.setListeners(), V.domReady(function() {
                V.poll(function() {
                    V.backgroundTasks()
                }, V.settings.recheckEvery || 3e3)
            }), V.domReady(function() {
                V.domReadyFired = !0, V.pageBottomFired || V.pageBottom(), V.firePageLoadEvent("domready")
            }), V.addEventHandler(e, "load", function() {
                V.firePageLoadEvent("windowload")
            }), V.firePageLoadEvent("pagetop"), V.initialized = !0
        }
    }, V.pageLoadPhases = ["aftertoolinit", "pagetop", "pagebottom", "domready", "windowload"], V.loadEventBefore = function(e, t) {
        return V.indexOf(V.pageLoadPhases, e) <= V.indexOf(V.pageLoadPhases, t)
    }, V.flushPendingCalls = function(e) {
        e.pending && (V.each(e.pending, function(t) {
            var n = t[0],
                a = t[1],
                i = t[2],
                r = t[3];
            n in e ? e[n].apply(e, [a, i].concat(r)) : e.emit ? e.emit(n, a, i, r) : V.notify("Failed to trigger " + n + " for tool " + e.id, 1)
        }), delete e.pending)
    }, V.setDebug = function(t) {
        try {
            e.localStorage.setItem("sdsat_debug", t)
        } catch (n) {
            V.notify("Cannot set debug mode: " + n.message, 2)
        }
    }, V.getUserAgent = function() {
        return navigator.userAgent
    }, V.detectBrowserInfo = function() {
        function e(e) {
            return function(t) {
                for (var n in e) {
                    if (e.hasOwnProperty(n))
    ...
    }, V.BaseTool = function(e) {
        this.settings = e || {}, this.forceLowerCase = V.settings.forceLowerCase, "forceLowerCase" in this.settings && (this.forceLowerCase = this.settings.forceLowerCase)
    }, V.BaseTool.prototype = {
        triggerCommand: function(e, t, n) {
            var a = this.settings || {};
            if (this.initialize && this.isQueueAvailable() && this.isQueueable(e) && n && V.loadEventBefore(n.type, a.loadOn)) this.queueCommand(e, t, n);
            else {
                var i = e.command,
                    r = this["$" + i],
                    s = !!r && r.escapeHtml,
                    o = V.preprocessArguments(e.arguments, t, n, this.forceLowerCase, s);
                r ? r.apply(this, [t, n].concat(o)) : this.$missing$ ? this.$missing$(i, t, n, o) : V.notify("Failed to trigger " + i + " for tool " + this.id, 1)
            }
        },
        endPLPhase: function() {},
        ...
        flushQueue: function() {
            this.pending && (V.each(this.pending, function(e) {
    ...
    }, e._satellite = V, a.prototype.getStringifiedValue = e.JSON && e.JSON.stringify || V.stringify, a.prototype.initPolling = function() {
        0 !== this.dataElementsNames.length && (this.dataElementsStore = this.getDataElementsValues(), V.poll(V.bind(this.checkDataElementValues, this), 1e3))
    }, a.prototype.getDataElementsValues = function() {
        var e = {};
        return V.each(this.dataElementsNames, function(t) {
            var n = V.getVar(t);
            e[t] = this.getStringifiedValue(n)
        }, this), e
    }, a.prototype.checkDataElementValues = function() {
        V.each(this.dataElementsNames, V.bind(function(e) {
            var n = this.getStringifiedValue(V.getVar(e));
            n !== this.dataElementsStore[e] && (this.dataElementsStore[e] = n, V.onEvent({
                type: "dataelementchange(" + e + ")",
                target: t
            }))
        }, this))
    }, V.availableEventEmitters.push(a), i.orientationChange = function(t) {
        var n = 0 === e.orientation ? "portrait" : "landscape";
        t.orientation = n, V.onEvent(t)
    }, V.availableEventEmitters.push(i), r.prototype = {
        defineEvents: function() {
            this.oldBlurClosure = function() {
                V.fireEvent("tabblur", t)
            }, this.oldFocusClosure = V.bind(function() {
                this.visibilityApiHasPriority ? V.fireEvent("tabfocus", t) : null != V.visibility.getHiddenProperty() && V.visibility.isHidden() || V.fireEvent("tabfocus", t)
            }, this)
        },
        attachDetachModernEventListeners: function(e) {
            V[0 == e ? "removeEventHandler" : "addEventHandler"](t, V.visibility.getVisibilityEvent(), this.handleVisibilityChange)
        },
        attachDetachOlderEventListeners: function(t, n, a) {
            var i = 0 == t ? "removeEventHandler" : "addEventHandler";
            V[i](n, a, this.oldBlurClosure), V[i](e, "focus", this.oldFocusClosure)
        },
        handleVisibilityChange: function() {
            V.visibility.isHidden() ? V.fireEvent("tabblur", t) : V.fireEvent("tabfocus", t)
        },
        setVisibilityApiPriority: function(t) {
            this.visibilityApiHasPriority = t, this.attachDetachOlderEventListeners(!1, e, "blur"), this.attachDetachModernEventListeners(!1), t ? null != V.visibility.getHiddenProperty() ? this.attachDetachModernEventListeners(!0) : this.attachDetachOlderEventListeners(!0, e, "blur") : (this.attachDetachOlderEventListeners(!0, e, "blur"), null != V.visibility.getHiddenProperty() && this.attachDetachModernEventListeners(!0))
        },
        oldBlurClosure: null,
        oldFocusClosure: null,
        visibilityApiHasPriority: !0
    }, V.availableEventEmitters.push(r), s.prototype.backgroundTasks = function() {
        V.each(this.rules, function(e) {
            V.cssQuery(e.selector, function(e) {
                if (e.length > 0) {
                    var t = e[0];
                    if (V.$data(t, "elementexists.seen")) return;
                    V.$data(t, "elementexists.seen", !0), V.onEvent({
                        type: "elementexists",
                        target: t
                    })
                }
    ...
    }, V.availableEventEmitters.push(s), o.prototype = {
        backgroundTasks: function() {
            var e = this.eventHandler;
            V.each(this.rules, function(t) {
                V.cssQuery(t.selector || "video", function(t) {
                    V.each(t, function(t) {
                        V.$data(t, "videoplayed.tracked") || (V.addEventHandler(t, "timeupdate", V.throttle(e, 100)), V.$data(t, "videoplayed.tracked", !0))
                    })
                })
            })
        },
        evalRule: function(e, t) {
            ...
            if (o) {
                ...
                !V.$data(e, n) && u() && (V.$data(e, n, !0), V.onEvent({
                    type: n,
                    target: e
                }))
            }
    ...
    }, V.availableEventEmitters.push(o), c.offset = function(n) {
        var a = null,
            i = null;
        try {
        ...
        backgroundTasks: function() {
            var e = this.elements;
            V.each(this.rules, function(t) {
                V.cssQuery(t.selector, function(n) {
                    var a = 0;
                    V.each(n, function(t) {
                        V.contains(e, t) || (e.push(t), a++)
                    }), a && V.notify(t.selector + " added " + a + " elements.", 1)
                })
            }), this.track()
        },
        checkInView: function(e, t, n) {
            var a = V.$data(e, "inview");
            if (c.isElementInView(e)) {
                a || V.$data(e, "inview", !0);
                var i = this;
                this.processRules(e, function(n, a, r) {
                    if (t || !n.inviewDelay) V.$data(e, a, !0), V.onEvent({
                        type: "inview",
                        target: e,
                        ...
                        }, n.inviewDelay), V.$data(e, r, s))
                    }
                }, n)
            } else {
                if (!c.isElementInDocument(e)) {
                    var r = V.indexOf(this.elements, e);
                    this.elements.splice(r, 1)
                }
                a && V.$data(e, "inview", !1), this.processRules(e, function(t, n, a) {
                    var i = V.$data(e, a);
                    i && clearTimeout(i)
                }, n)
            }
        ...
        processRules: function(e, t, n) {
            var a = this.rules;
            n && (a = V.filter(this.rules, function(e) {
                return e.inviewDelay == n
            })), V.each(a, function(n, a) {
                var i = n.inviewDelay ? "viewed_" + n.inviewDelay : "viewed",
                    r = "inview_timeout_id_" + a;
                V.$data(e, i) || V.matchesCss(n.selector, e) && t(n, i, r)
            })
        }
    }, V.availableEventEmitters.push(c), l.prototype = {
        obue: !1,
        initialize: function() {
        ...
        attachCloseListeners: function() {
            this.prevUnload = e.onunload, this.prevBeforeUnload = e.onbeforeunload, e.onunload = V.bind(function(t) {
                this.prevUnload && setTimeout(V.bind(function() {
                    this.prevUnload.call(e, t)
                }, this), 1), this.newObueListener()
            }, this), e.onbeforeunload = V.bind(function(t) {
                this.prevBeforeUnload && setTimeout(V.bind(function() {
    ...
    }, V.availableEventEmitters.push(l), u.prototype = {
        backgroundTasks: function() {
            var e = this;
            V.each(this.rules, function(t) {
                var n = t[1],
                    a = t[0];
                V.cssQuery(n, function(t) {
                    V.each(t, function(t) {
                        e.trackElement(t, a)
                    })
                })
        ...
        trackElement: function(e, t) {
            var n = this,
                a = V.$data(e, "hover.delays");
            a ? V.contains(a, t) || a.push(t) : (V.addEventHandler(e, "mouseover", function(t) {
                n.onMouseOver(t, e)
            }), V.addEventHandler(e, "mouseout", function(t) {
                n.onMouseOut(t, e)
            }), V.$data(e, "hover.delays", [t]))
        },
        onMouseOver: function(e, t) {
            var n = e.target || e.srcElement,
                a = e.relatedTarget || e.fromElement;
            (t === n || V.containsElement(t, n)) && !V.containsElement(t, a) && this.onMouseEnter(t)
        },
        onMouseEnter: function(e) {
            var t = V.$data(e, "hover.delays"),
            ...
            V.$data(e, "hover.delayTimers", n)
        },
        onMouseOut: function(e, t) {
            var n = e.target || e.srcElement,
                a = e.relatedTarget || e.toElement;
            (t === n || V.containsElement(t, n)) && !V.containsElement(t, a) && this.onMouseLeave(t)
        },
        onMouseLeave: function(e) {
            var t = V.$data(e, "hover.delayTimers");
            t && V.each(t, function(e) {
                clearTimeout(e)
            })
        }
    }, V.availableEventEmitters.push(u), d.prototype = {
        initialize: function() {
        ...
        bind: function() {
            this.FB.Event.subscribe("edge.create", function() {
                V.notify("tracking a facebook like", 1), V.onEvent({
                    type: "facebook.like",
                    target: t
                })
            }), this.FB.Event.subscribe("edge.remove", function() {
                V.notify("tracking a facebook unlike", 1), V.onEvent({
                    type: "facebook.unlike",
                    target: t
                })
            }), this.FB.Event.subscribe("message.send", function() {
                V.notify("tracking a facebook share", 1), V.onEvent({
                    type: "facebook.send",
                    target: t
                })
            })
        }
    }, V.availableEventEmitters.push(d), p.prototype = {
        initialize: function() {
            var e = this.twttr;
            e && "function" == typeof e.ready && e.ready(V.bind(this.bind, this))
        },
        bind: function() {
            this.twttr.events.bind("tweet", function(e) {
                e && (V.notify("tracking a tweet button", 1), V.onEvent({
                    type: "twitter.tweet",
                    target: t
                }))
            })
        }
    }, V.availableEventEmitters.push(p), f.prototype = {
        initialize: function() {
        ...
        setupHistoryAPI: function() {
            var t = e.history;
            t && (t.pushState && (this.originalPushState = t.pushState, t.pushState = this._pushState), t.replaceState && (this.originalReplaceState = t.replaceState, t.replaceState = this._replaceState)), V.addEventHandler(e, "popstate", this._onPopState)
        },
        pushState: function() {
        ...
        setupHashChange: function() {
            V.addEventHandler(e, "hashchange", this._onHashChange)
        },
        ...
        cleanUpHistoryAPI: function() {
            history.pushState === this._pushState && (history.pushState = this.originalPushState), history.replaceState === this._replaceState && (history.replaceState = this.originalReplaceState), V.removeEventHandler(e, "popstate", this._onPopState)
        },
        cleanUpHashChange: function() {
            V.removeEventHandler(e, "hashchange", this._onHashChange)
        }
    }, V.availableEventEmitters.push(f), V.ecommerce = {
        addItem: function() {
    ...
    }, V.inherit(g, V.BaseTool), V.extend(g.prototype, {
        name: "Nielsen",
        ...
        defineListeners: function() {
            this.onTabFocus = V.bind(function() {
                this.notify("Tab visible, sending view beacon when ready", 1), this.tabEverVisible = !0, this.flushQueueWhenReady()
            }, this), this.onPageLeave = V.bind(function() {
                this.notify("isHuman? : " + this.isHuman(), 1), this.isHuman() && this.sendDurationBeacon()
            }, this), this.onHumanDetectionChange = V.bind(function(e) {
                this == e.target.target && (this.human = e.target.isHuman)
            }, this)
        },
        initialize: function() {
            this.initializeTracking(), this.initializeDataProviders(), this.initializeNonHumanDetection(), this.tabEverVisible = V.visibility.isVisible(), this.tabEverVisible ? this.notify("Tab visible, sending view beacon when ready", 1) : V.bindEventOnce("tabfocus", this.onTabFocus), this.initialized = !0
        },
        ...
        initializeDataProviders: function() {
            ...
            this.dataProvider.register(new g.DataProvider.VisitorID(V.getVisitorId())), t ? (e = new g.DataProvider.Generic("rsid", function() {
        ...
        initializeNonHumanDetection: function() {
            V.nonhumandetection ? (V.nonhumandetection.init(), this.setEnableNonHumanDetection(0 != this.settings.enableNonHumanDetection), this.settings.nonHumanDetectionDelay > 0 && this.setNonHumanDetectionDelay(1e3 * parseInt(this.settings.nonHumanDetectionDelay))) : this.notify("NHDM is not available.")
        },
        getAnalyticsTool: function() {
            if (this.settings.integratesWith) return V.tools[this.settings.integratesWith]
        },
        flushQueueWhenReady: function() {
            this.enableTracking && this.tabEverVisible && V.poll(V.bind(function() {
        ...
        setEnableNonHumanDetection: function(e) {
            e ? V.nonhumandetection.register(this) : V.nonhumandetection.unregister(this)
        },
        setNonHumanDetectionDelay: function(e) {
            V.nonhumandetection.register(this, e)
        },
        addRemovePageLeaveEvent: function(e) {
            this.notify((e ? "Attach onto" : "Detach from") + " page leave event", 1), V[0 == e ? "unbindEvent" : "bindEvent"]("leave", this.onPageLeave)
        },
        addRemoveHumanDetectionChangeEvent: function(e) {
            this.notify((e ? "Attach onto" : "Detach from") + " human detection change event", 1), V[0 == e ? "unbindEvent" : "bindEvent"]("humandetection.change", this.onHumanDetectionChange)
        },
        sendViewBeacon: function() {
            this.notify("Tracked page view.", 1), this.sendBeaconWith()
        },
        sendDurationBeacon: function() {
            if (V.timetracking && "function" == typeof V.timetracking.timeOnPage && null != V.timetracking.timeOnPage()) {
                this.notify("Tracked close", 1), this.sendBeaconWith({
                    timeOnPage: Math.round(V.timetracking.timeOnPage() / 1e3),
                    duration: "D",
                    timer: "timer"
                });
                var e;
        ...
        prepareUrl: function(e) {
            var t = this.settings;
            return V.extend(t, this.dataProvider.provide()), V.extend(t, e), this.preparePrefix(this.settings.collectionServer) + this.adapt.convertToURI(this.adapt.toNielsen(this.substituteVariables(t)))
        },
        ...
        substituteVariables: function(e) {
            var t = {};
            for (var n in e) e.hasOwnProperty(n) && (t[n] = V.replace(e[n]));
            return t
        },
    ...
    }, V.extend(g.DataProvider.Generic.prototype, {
        isReady: function() {
            return !0
        },
        getValue: function() {
    ...
    }, V.inherit(g.DataProvider.VisitorID, g.DataProvider.Generic), V.extend(g.DataProvider.VisitorID.prototype, {
        isReady: function() {
    ...
    }, V.extend(g.DataProvider.Aggregate.prototype, {
        register: function(e) {
            this.providers.push(e)
        },
        isReady: function() {
            return V.every(this.providers, function(e) {
                return e.isReady()
            })
        },
        provide: function() {
            var e = {};
            return V.each(this.providers, function(t) {
                V.extend(e, t.provide())
            }), e
        }
    }), g.UUID = function() {}, V.extend(g.UUID.prototype, {
        generate: function() {
        ...
        get: function() {
            var e = V.readCookie(this.key("uuid"));
            return e || (e = this.generate(), V.setCookie(this.key("uuid"), e), e)
        },
        key: function(e) {
            return "_dtm_nielsen_" + e
        }
    }), g.DataAdapters = function() {}, V.extend(g.DataAdapters.prototype, {
    ...
    }), V.availableTools.nielsen = g, V.extend(h.prototype, {
        getInstance: function() {
            return this.instance
        },
        initialize: function() {
            var e, t = this.settings;
            V.notify("Visitor ID: Initializing tool", 1), null !== (e = this.createInstance(t.mcOrgId, t.initVars)) && (t.customerIDs && this.applyCustomerIDs(e, t.customerIDs), t.autoRequest && e.getMarketingCloudVisitorID(), this.instance = e)
        },
        createInstance: function(e, t) {
            if (!V.isString(e)) return V.notify('Visitor ID: Cannot create instance using mcOrgId: "' + e + '"', 4), null;
            e = V.replace(e), V.notify('Visitor ID: Create instance using mcOrgId: "' + e + '"', 1), t = this.parseValues(t);
            var n = Visitor.getInstance(e, t);
            return V.notify("Visitor ID: Set variables: " + V.stringify(t), 1), n
        },
        applyCustomerIDs: function(e, t) {
            var n = this.parseIds(t);
            e.setCustomerIDs(n), V.notify("Visitor ID: Set Customer IDs: " + V.stringify(n), 1)
        },
        ...
        parseIds: function(e) {
            ...
            for (var n in e)
                if (e.hasOwnProperty(n)) {
                    var a = V.replace(e[n].id);
                    a !== e[n].id && a && (t[n] = {}, t[n].id = a, t[n].authState = Visitor.AuthState[e[n].authState])
                } return t
        }
    }), V.availableTools.visitor_id = h, V.inherit(v, V.BaseTool), V.extend(v.prototype, {
        name: "SC",
        endPLPhase: function(e) {
        ...
        initialize: function(t) {
            if (!this._cancelToolInit)
                if (this.settings.initVars = this.substituteVariables(this.settings.initVars, {
                    ...
                    var n = this.settings.sCodeURL || V.basePath() + "s_code.js";
                    "object" == typeof n && (n = "https:" === e.location.protocol ? n.https : n.http), n.match(/^https?:/) || (n = V.basePath() + n), this.settings.initVars && this.$setVars(null, null, this.settings.initVars), V.loadScript(n, V.bind(this.onSCodeLoaded, this)), this.initializing = !0
        ...
        getS: function(t, n) {
            var a = n && n.hostname || e.location.hostname,
                ...
                o = e.s_gi;
            if (!o) return null;
            if (this.isValidSCInstance(t) || (t = null), !s && !t) return V.notify("Adobe Analytics: tracker not initialized because account was not found", 1), null;
            t = t || o(s);
            var c = "D" + V.appVersion;
        ...
        onSCodeLoaded: function(e) {
            ...
            V.notify(t.join(""), 1), V.fireEvent(this.id + ".load", this.getS()), e || (this.flushQueueExceptTrackLink(), this.sendBeacon()), this.flushQueue()
        },
        ...
        sendBeacon: function() {
            ...
            t ? this.settings.customInit && !1 === this.settings.customInit(t) ? V.notify("Adobe Analytics: custom init suppressed beacon", 1) : (this.settings.executeCustomPageCodeFirst && this.applyVarBindingsOnTracker(t, this.varBindings), this.executeCustomSetupFuns(t), t.t(), this.clearVarBindings(), this.clearCustomSetup(), V.notify("Adobe Analytics: tracked page view", 1)) : V.notify("Adobe Analytics: page code not loaded", 1)
        },
        pollForSC: function() {
            V.poll(V.bind(function() {
        ...
        $setVars: function(e, t, n) {
            for (var a in n)
                ...
                } V.notify("Adobe Analytics: set variables.", 2)
        },
        ...
        concatWithToolVarBindings: function(e) {
            ...
            return V.map(["trackingServer", "trackingServerSecure"], function(n) {
                t[n] && !e[n] && (e[n] = t[n])
            }), e
        },
        ...
        executeCustomSetupFuns: function(t) {
            V.each(this.customSetupFuns, function(n) {
                n.call(e, t)
            })
        },
        $trackLink: function(e, t, n) {
            ...
            if (o) {
                ...
                var d = V.map(s, function(e) {
                    return e.split(":")[0]
                });
                o.linkTrackEvents = this.getCustomLinkVarsList(d), o.tl(!0, a || "o", i), V.notify(["Adobe Analytics: tracked link ", "using: linkTrackVars=", V.stringify(o.linkTrackVars), "; linkTrackEvents=", V.stringify(o.linkTrackEvents)].join(""), 1), o.linkTrackVars = c, o.linkTrackEvents = l
            } else V.notify("Adobe Analytics: page code not loaded", 1)
        },
        mergeTrackLinkVars: function(e, t) {
            return e && (t = e.split(",").concat(t)), t
        },
        getCustomLinkVarsList: function(e) {
            var t = V.indexOf(e, "None");
        ...
        $trackPageView: function(e, t, n) {
            ...
            r ? (r.linkTrackVars = "", r.linkTrackEvents = "", this.executeCustomSetupFuns(r), n && n.customSetup && n.customSetup.call(e, t, r), r.t(), this.clearVarBindings(), this.clearCustomSetup(), V.notify("Adobe Analytics: tracked page view", 1)) : V.notify("Adobe Analytics: page code not loaded", 1)
        },
        $postTransaction: function(t, n, a) {
            var i = V.data.transaction = e[a],
                r = this.varBindings,
                s = this.settings.fieldVarMapping;
            if (V.each(i.items, function(e) {
                    this.products.push(e)
                }, this), r.products = V.map(this.products, function(e) {
                    var t = [];
                    if (s && s.item)
                        for (var n in s.item)
    ...
    }), V.availableTools.sc = v, V.inherit(m, V.BaseTool), V.extend(m.prototype, {
        name: "Default",
        $loadIframe: function(t, n, a) {
            ...
            r || s(), "domready" === r && V.domReady(s), "load" === r && V.addEventHandler(e, "load", s)
        },
        loadIframe: function(e, n, a) {
            ...
            var r = V.data.host,
                ...
                c = V.searchVariables(s, e, n);
            r && (o = V.basePath() + o), o += c, i.src = o;
            var l = t.getElementsByTagName("body")[0];
            l ? l.appendChild(i) : V.domReady(function() {
                t.getElementsByTagName("body")[0].appendChild(i)
            })
        },
        scriptURL: function(e) {
            return (V.settings.scriptDir || "") + e
        },
        $loadScript: function(t, n, a) {
            var i = a.scripts,
                ...
                s = a.loadOn,
                o = V.bind(function() {
                    r ? this.loadScripts(t, n, i) : V.each(i, function(e) {
                        this.loadScripts(t, n, [e])
                    }, this)
                }, this);
            s ? "domready" === s ? V.domReady(o) : "load" === s && V.addEventHandler(e, "load", o) : o()
        },
        loadScripts: function(e, t, n) {
            function a() {
                ...
                if (c) {
                    var l = V.data.host,
                        u = o.scriptURL(c.src);
                    l && (u = V.basePath() + u), i = c, V.loadScript(u, a)
                }
            }
            try {
                n = n.slice(0);
                ...
                console.error("scripts is", V.stringify(n))
            }
            a()
        },
        ...
        loadBlockingScript: function(e, t, n) {
            ...
            i && (a = V.basePath() + a), this.argsForBlockingScripts.push([e, t, r]), V.loadScriptSync(a)
        },
        pushAsyncScript: function(e) {
        ...
        $writeHTML: V.escapeHtmlParams(function(e, n) {
            if (!V.domReadyFired && t.write)
                if ("pagebottom" === n.type || "pagetop" === n.type)
                    for (var a = 2, i = arguments.length; a < i; a++) {
                        var r = arguments[a].html;
                        r = V.replace(r, e, n), t.write(r)
                    } else V.notify("You can only use writeHTML on the `pagetop` and `pagebottom` events.", 1);
                else V.notify("Command writeHTML failed. You should try appending HTML using the async option.", 1)
        }),
        ...
        $delayActivateLink: function(e, t) {
            if (this.linkNeedsDelayActivate(e)) {
                V.preventDefault(t);
                var n = V.settings.linkDelay || 100;
                setTimeout(function() {
                    V.setLocation(e.href)
                }, n)
            }
        },
        isQueueable: function(e) {
    ...
    }), V.availableTools["default"] = m, V.inherit(_, V.BaseTool), V.extend(_.prototype, {
        name: "tnt",
        endPLPhase: function(e) {
            "aftertoolinit" === e && this.initialize()
        },
        initialize: function() {
            V.notify("Test & Target: Initializing", 1), this.initializeTargetPageParams(), this.load()
        },
        ...
        load: function() {
            ...
            !1 !== this.settings.initTool ? this.settings.loadSync ? (V.loadScriptSync(e), this.onScriptLoaded()) : (V.loadScript(e, V.bind(this.onScriptLoaded, this)), this.initializing = !0) : this.initialized = !0
        },
        getMboxURL: function(t) {
            var n = t;
            return V.isObject(t) && (n = "https:" === e.location.protocol ? t.https : t.http), n.match(/^https?:/) ? n : V.basePath() + n
        },
        onScriptLoaded: function() {
            V.notify("Test & Target: loaded.", 1), this.flushQueue(), this.initialized = !0, this.initializing = !1
        },
        ...
        $addMBoxStep2: function(n, a, i) {
            var r = this.generateID(),
                s = this;
            V.addEventHandler(e, "load", V.bind(function() {
                V.cssQuery(i.mboxGoesAround, function(n) {
                    var a = n[0];
                    if (a) {
        ...
        reappearWhenCallComesBack: function(e, t, n, a) {
            ...
            var r = this;
            V.cssQuery('script[src*="omtrdc.net"]', function(e) {
                var t = e[0];
                if (t) {
                    V.scriptOnLoad(t.src, t, function() {
                        V.notify("Test & Target: request complete", 1), i(), clearTimeout(a)
                    });
                    var a = setTimeout(function() {
                        V.notify("Test & Target: bailing after " + n + "ms", 1), i()
                    }, n)
                } else V.notify("Test & Target: failed to find T&T ajax call, bailing", 1), i()
            })
        },
        updateTargetPageParams: function(e) {
            var t = {};
            for (var n in e) e.hasOwnProperty(n) && (t[V.replace(n)] = V.replace(e[n]));
            V.extend(this.targetPageParamsStore, t)
        },
        getTargetPageParams: function() {
            return this.targetPageParamsStore
        },
        setTargetPageParamsFunction: function() {
            e.targetPageParams = V.bind(this.getTargetPageParams, this)
        },
        parseTargetPageParamsResult: function(e) {
            var t = e;
            return V.isArray(e) && (e = e.join("&")), V.isString(e) && (t = V.parseQueryParams(e)), t
        }
    }), V.availableTools.tnt = _, V.inherit(y, V.BaseTool), V.extend(y.prototype, {
        initialize: function() {
            var e = this.settings;
            if (!1 !== this.settings.initTool) {
                var t = e.url;
                t = "string" == typeof t ? V.basePath() + t : V.isHttps() ? t.https : t.http, V.loadScript(t, V.bind(this.onLoad, this)), this.initializing = !0
        ...
        endPLPhase: function(e) {
            e === this.settings.loadOn && (V.notify(this.name + ": Initializing at " + e, 1), this.initialize())
        },
        $fire: function(e, t, n) {
    ...
    }), V.availableTools.am = y, V.availableTools.adlens = y, V.availableTools.aem = y, V.availableTools.__basic = y;
    var I = {
        allowLinker: function() {
            return V.hasMultipleDomains()
        },
        cookieDomain: function() {
            var t = V.settings.domainList,
                n = V.find(t, function(t) {
                    var n = e.location.hostname;
                    return V.equalsIgnoreCase(n.slice(n.length - t.length), t)
                });
            return n ? "." + n : "auto"
        }
    };
    V.inherit(k, V.BaseTool), V.extend(k.prototype, {
        name: "GAUniversal",
        endPLPhase: function(e) {
            e === this.settings.loadOn && (V.notify("GAU: Initializing at " + e, 1), this.initialize(), this.flushQueue(), this.trackInitialPageView())
        },
        ...
        initialize: function() {
            if (this.isPageCodeLoadSuppressed()) return this.initialized = !0, void V.notify("GAU: Page code not loaded (suppressed).", 1);
            var t = "ga";
            e[t] = e[t] || this.createGAObject(), e.GoogleAnalyticsObject = t, V.notify("GAU: Page code loaded.", 1), V.loadScriptOnce(this.getToolUrl());
            var n = this.settings;
        ...
        create: function(e) {
            ...
            (t = V.preprocessArguments([t], location, null, this.forceLowerCase)[0]).trackingId = V.replace(this.settings.trackerSettings.trackingId, location), t.cookieDomain || (t.cookieDomain = I.cookieDomain()), V.extend(t, e || {}), this.call("create", t)
        },
        autoLinkDomains: function() {
            var e = location.hostname;
            return V.filter(V.settings.domainList, function(t) {
                return t !== e
            })
        },
        executeInitCommands: function() {
            var e = this.settings;
            e.initCommands && V.each(e.initCommands, function(e) {
                var t = e.splice(2, e.length - 2);
                e = e.concat(V.preprocessArguments(t, location, null, this.forceLowerCase)), this.call.apply(this, e)
            }, this)
        },
        ...
        call: function() {
            "function" == typeof ga ? this.isCallSuppressed() || (arguments[0] = this.cmd(arguments[0]), this.log(V.toArray(arguments)), ga.apply(e, arguments)) : V.notify("GA Universal function not found!", 4)
        },
        ...
        cmd: function(e) {
            ...
            return n && -1 !== V.indexOf(t, e) ? n + "." + e : e
        },
        log: function(e) {
            var t = "GA Universal: sent command " + e[0] + " to tracker " + (this.getTrackerName() || "default");
            if (e.length > 1) {
                V.stringify(e.slice(1));
                t += " with parameters " + V.stringify(e.slice(1))
            }
            t += ".", V.notify(t, 1)
        }
    }), V.availableTools.ga_universal = k, V.inherit(b, V.BaseTool), V.extend(b.prototype, {
        name: "GA",
        initialize: function() {
            var t = this.settings,
                n = e._gaq,
                a = t.initCommands || [],
                i = t.customInit;
            if (n || (_gaq = []), this.isSuppressed()) V.notify("GA: page code not loaded(suppressed).", 1);
            else {
                if (!n && !b.scriptLoaded) {
                    var r = V.isHttps(),
                        s = (r ? "https://ssl" : "http://www") + ".google-analytics.com/ga.js";
                    t.url && (s = r ? t.url.https : t.url.http), V.loadScript(s), b.scriptLoaded = !0, V.notify("GA: page code loaded.", 1)
                }
                t.domain;
                var o = t.trackerName,
                    c = I.allowLinker(),
                    l = V.replace(t.account, location);
                V.settings.domainList;
                _gaq.push([this.cmd("setAccount"), l]), c && _gaq.push([this.cmd("setAllowLinker"), c]), _gaq.push([this.cmd("setDomainName"), I.cookieDomain()]), V.each(a, function(e) {
                    var t = [this.cmd(e[0])].concat(V.preprocessArguments(e.slice(1), location, null, this.forceLowerCase));
                    _gaq.push(t)
                }, this), i && (this.suppressInitialPageView = !1 === i(_gaq, o)), t.pageName && this.$overrideInitialPageView(null, null, t.pageName)
            }
            this.initialized = !0, V.fireEvent(this.id + ".configure", _gaq, o)
        },
        ...
        trackInitialPageView: function() {
            if (!this.isSuppressed() && !this.suppressInitialPageView)
                if (this.urlOverride) {
                    var e = V.preprocessArguments([this.urlOverride], location, null, this.forceLowerCase);
                    this.$missing$("trackPageview", null, null, e)
                } else this.$missing$("trackPageview")
        },
        endPLPhase: function(e) {
            e === this.settings.loadOn && (V.notify("GA: Initializing at " + e, 1), this.initialize(), this.flushQueue(), this.trackInitialPageView())
        },
        call: function(e, t, n, a) {
            if (!this._cancelToolInit) {
                ...
                var i = this.tracker(),
                    r = this.cmd(e);
                a = a ? [r].concat(a) : [r];
                _gaq.push(a), i ? V.notify("GA: sent command " + e + " to tracker " + i + (a.length > 1 ? " with parameters [" + a.slice(1).join(", ") + "]" : "") + ".", 1) : V.notify("GA: sent command " + e + (a.length > 1 ? " with parameters [" + a.slice(1).join(", ") + "]" : "") + ".", 1)
            }
        },
        $missing$: function(e, t, n, a) {
            this.call(e, t, n, a)
        ...
        $postTransaction: function(t, n, a) {
            var i = V.data.customVars.transaction = e[a];
            this.call("addTrans", t, n, [i.orderID, i.affiliation, i.total, i.tax, i.shipping, i.city, i.state, i.country]), V.each(i.items, function(e) {
        ...
        delayLink: function(e, t) {
            var n = this;
            if (I.allowLinker() && e.hostname.match(this.settings.linkerDomains) && !V.isSubdomainOf(e.hostname, location.hostname)) {
                V.preventDefault(t);
                var a = V.settings.linkDelay || 100;
                setTimeout(function() {
    ...
    }), V.availableTools.ga = b, _satellite.init({
        tools: {
            "38c98156a8f55a5bc92ba8fed1cd7ec0": {
                ...
                customInit: function(n) {
                    if (e.s = n, !e.pageDataTracker) return !1;
                    pageDataTracker.mapAdobeVars(n), n._tpDST = {
                        2012: "3/11,11/4",
                        2013: "3/10,11/3",
                        2014: "3/9,11/2",
                        2015: "3/8,11/1",
                        ...
                        2032: "3/14,11/7",
                        2033: "3/13,11/6"
                    }, n.usePlugins = !0, n.linkInternalFilters = (n.linkInternalFilters ? n.linkInternalFilters + "," : "") + t.location.hostname, e.s_doPlugins = function(n) {
                        if (e.pageData && "true" != pageData.page.noTracking && pageData.isLoaded || (n.abort = !0, e.pageData)) {
                            if (pageData.page.lastTrackedPage = pageData.page.analyticsPagename, "object" != typeof e.eventData || "newPage" != e.eventData.eventName && "searchResultsUpdated" != e.eventData.eventName || (n.clearVars(), n.pageLoaded = !1, pageDataTracker.getEvents(), pageDataTracker.mapAdobeVars(n)), n.list3 = _satellite.getVar("Promo - IDs"), n.list3 && (n.linkTrackVars = n.apl(n.linkTrackVars, "list3", ",", 2)), n.eVar21 = _satellite.getVar("Promo - Clicked ID"), n.eVar21 && (n.list3 = n.eVar21, n.linkTrackVars = n.apl(n.linkTrackVars, "eVar21", ",", 2)), n.account = n.getCustomReportSuites(), pageDataTracker.customDoPlugins(n) || pageDataTracker.addMessage("dtm5"), n.tpEls = n.getTimeParting("n", "-5").split("|"), n.prop5 = n.tpEls[0] + " " + n.tpEls[1], n.prop9 = n.version, n.prop32 = t.location.protocol.replace(/\:/g, ""), n.eVar8 = n.getDaysSinceLastVisit("v8"), n.eVar50 = Visitor.getInstance("4D6368F454EC41940A4C98A6@AdobeOrg").getMarketingCloudVisitorID(), e.pageData && pageData.page && "cert" == pageData.page.environment && (n.account = n.account.replace(/\-(dev|prod)/gi, "-cert")), n.campaign && n.prop2 && 0 != n.campaign.indexOf(n.prop2 + ":") && (n.campaign = n.prop2 + ":" + n.campaign), n.campaign && (n.eVar108 = "D=v0", n.linkTrackVars = n.apl(n.linkTrackVars, "eVar108", ",", 2)), n.events = n.events ? n.events : "", n.products = pageDataTracker.setProductsVariable(), !n.pageLoaded && n.pageName) {
                                if (n.server = t.location.hostname, n.prop18 = "http://" + t.location.hostname + t.location.pathname, n.prop19 = n.getPreviousValue(n.pageName, "c19", ""), n.prop19) {
                                    var a = n.getPercentPageViewed(n.pageName);
                                    a && a.length > 2 && "undefined" != a[1] && "undefined" != typeof a[1] && "undefined" != a[2] && "undefined" != typeof a[2] ? n.prop17 = a[1] + "|" + a[2] : n.prop17 = "no data available"
                                }
                                if (n.eVar66 = n.eVar67 = "+1", n.events = n.apl(n.events, "event27", ",", 2), e.pageData && pageData.trackEvents && pageData.trackEvents instanceof Array) {
                                    for (var i = {
                                            associationStart: "event199",
                                            associated: "event200",
                                            contentEdit: "event190",
                                            contentAddition: "event79"
                                        }, r = 0; r < pageData.trackEvents.length; r++) {
                                        var s = i[pageData.trackEvents[r]];
                                        s && (n.events = n.apl(n.events, s, ",", 2))
                                    }
                                    pageData.trackEvents = []
                                }
                                var o = new Date,
                                    c = _satellite.getVar("Visitor - User ID");
                                c = c ? c.toLowerCase() : "", c += o.getFullYear(), c += o.getMonth(), c = pageDataTracker.md5(c).substring(0, 20), n.events = n.apl(n.events, "event203:" + c, ",", 2);
                                var l = _satellite.getVar("Visitor - Account ID");
                                l && (l = l.toLowerCase(), l += o.getFullYear(), l += o.getMonth(), l = pageDataTracker.md5(l).substring(0, 20), n.events = n.apl(n.events, "event205:" + l, ",", 2)), n.eVar72 && (n.events = n.apl(n.events, "event9", ",", 2)), e.pageData && pageData.visitor && pageData.visitor.loginSuccess && "true" == pageData.visitor.loginSuccess && (n.events = n.apl(n.events, "event23", ",", 2), pageData.visitor.loginSuccess = "false"), e.pageData && pageData.visitor && pageData.visitor.loginFailure && "true" == pageData.visitor.loginFailure && (n.events = n.apl(n.events, "event134", ",", 2), pageData.visitor.loginFailure = "false");
                                if (n.eVar19 && (n.eVar19 = n.cleanUrlData(n.eVar19), n.prop21 || (n.prop21 = n.eVar19)), n.prop21) {
                                    n.prop21 = n.cleanUrlData(n.prop21), n.getValOnce(n.prop21, "c21", 0) && (n.events = n.apl(n.events, "event3", ",", 2), n.eVar35 = n.eVar36 = "+1", "0" == n.eVar3 ? (n.eVar3 = "zero", n.events = n.apl(n.events, "event4", ",", 2)) : n.eVar3 && (n.events = n.apl(n.events, "event14=" + n.eVar3, ",", 2)));
                                    var u = _satellite.getVar("Search - Results per Page");
                                    n.getValOnce((n.eVar19 && n.eVar19 == n.prop21 ? "" : n.prop21) + ":" + _satellite.getVar("Search - Current Page"), "e13", 0) && u && (n.events = n.apl(n.events, "event13=" + u, ",", 2))
                                }
                                n.eVar117 && n.getValOnce(n.eVar117, "v117", 0) && (n.events = n.apl(n.events, "event198", ",", 2)), n.prop13 && n.getValOnce(n.prop13, "c13", 0) && (n.events = n.apl(n.events, "event24", ",", 2)), (n.prop7 || n.eVar46) && n.getValOnce(n.prop7 || n.eVar46, "c7", 0) && (n.events = n.apl(n.events, "event6", ",", 2)), n.prop60 && n.getValOnce(n.prop60, "c60", 0) && (n.events = n.apl(n.events, "event88", ",", 2));
                                var d = n.getValOnce("1", "e41", 0);
                                n.clickPast(d, "event41", "event42"), n.events.indexOf("event41") > -1 && p && n.c_w("v31", p), n.list3 && (n.events = n.apl(n.events, "event21", ",", 2));
                                var p = _satellite.getVar("Page - Load Timestamp"),
                                    f = n.getPreviousValue(p, "v68", "") || p,
                                    g = n.c_r("v31") || p;
                                if (p) try {
                                    var h = new Date(parseInt(p)).getTime();
                                    n.eVar113 = (Math.floor((h / 1e3 - 18e3) % 86400) + 1).toString(), n.linkTrackVars = n.apl(n.linkTrackVars, "eVar113", ",", 2)
                                } catch (O) {}
                                if (p && f) try {
                                    var v = new Date(parseInt(p)),
                                        m = new Date(parseInt(f)),
                                        _ = new Date(parseInt(g)),
                                        y = v.getTime() - m.getTime();
                                    y > 0 && (n.eVar68 = "+" + (y / 1e3).toFixed(0)), n.currentVisitTime = ((v.getTime() - _.getTime()) / 1e3).toFixed(0)
                                } catch (O) {}
                                if (pageData.eventList)
                                    for (var k = 0; k < pageData.eventList.length; k++) "product turnaway" == pageData.eventList[k] && (n.events = n.apl(n.events, "event43", ",", 2));
                                if (n.eVar43 && (n.events = n.apl(n.events, "event26", ",", 2)), n.eVar44 && (n.events = n.apl(n.events, "event17", ",", 2)), pageData.page && pageData.page.purchaseStep) {
                                    var b = "";
                                    ...
                                    b && (n.events = n.apl(n.events, b, ",", 2), "scView" == b && (n.events = n.apl(n.events, "scOpen", ",", 2)))
                                }
                                n.list2 && (n.events = n.apl(n.events, "event178", ",", 2));
                                try {
                                    n.prop66 = pageDataTracker.getMessages(), n.prop66 && (n.linkTrackVars = n.apl(n.linkTrackVars, "prop66", ",", 2));
                                    var D = pageDataTracker.getPerformance();
                                    D.du && (n.eVar114 = D.du, n.linkTrackVars = n.apl(n.linkTrackVars, "eVar114", ",", 2)), D.lt && (n.eVar115 = D.lt, n.linkTrackVars = n.apl(n.linkTrackVars, "eVar115", ",", 2))
                                } catch (M) {}
                                for (var S = ["utm_campaign", "dgcid", "utm_dgroup", "utm_in", "utm_medium", "utm_acid", "cmx_id", "sis_id", "utm_source", "utm_term", "utm_content"], C = "", T = !1, E = 0; E < S.length; E++) {
                                    var V = _satellite.getQueryParamCaseInsensitive(S[E]) || "";
                                    V && (T = !0), C += V + "|"
                                }
                                T && (n.eVar125 = C), n.pageLoaded = !0
                            }
                            var I;
                            if (n.prop4 && null !== n.prop4.match(/^CP\-/gi) && !n.linkType || n.linkName && "content view" == n.linkName) {
                                if ((I = pageDataTracker.getContentItem()) && I.id && !I.turnawayId) {
                                    n.events = n.apl(n.events, "prodView", ",", 2), n.events = n.apl(n.events, "event5", ",", 2), n.events = n.apl(n.events, "event40", ",", 2), n.events = n.apl(n.events, "event181", ",", 2), n.events = n.apl(n.events, "event182", ",", 2), n.events = n.apl(n.events, "event184", ",", 2);
                                    var w = _satellite.getVar("Visitor - App Session ID"),
                                        P = pageDataTracker.md5((w || "none") + I.id).substring(0, 20);
                                    if (n.events = n.apl(n.events, "event201:" + P, ",", 2), I.type && -1 !== I.type.toLowerCase().indexOf("scope-full") && (n.events = n.apl(n.events, "event202:" + P, ",", 2)), n.eVar24 = "+1", n.eVar25 = "+1", n.prop11 = I.id, n.prop31 = pageDataTracker.getBibliographicInfo(I), I.format)
                                        if (null !== I.format.match(/\-X?HTML/gi)) {
                                            b = "";
                                            b = null !== I.format.match(/scope\-abstract/gi) || null !== I.type.match(/scope\-abstract/gi) ? "event33" : "event29", n.events = n.apl(n.events, b, ",", 2), n.linkTrackEvents = n.apl(n.linkTrackEvents, b, ",", 2)
                                        } else null !== I.format.match(/\-PDF/gi) && (n.events = n.apl(n.events, "event30", ",", 2), n.linkTrackEvents = n.apl(n.linkTrackEvents, "event30", ",", 2));
                                    null !== n.prop4.match(/^CP\-DL/gi) && (n.events = n.apl(n.events, "event19", ",", 2)), I.viewState && ("login" == I.viewState ? (n.events = n.apl(n.events, "event103", ",", 2), n.linkTrackEvents = n.apl(n.linkTrackEvents, "event103", ",", 2)) : "upsell" == I.viewState && (n.events = n.apl(n.events, "event104", ",", 2), n.linkTrackEvents = n.apl(n.linkTrackEvents, "event104", ",", 2))), I.indexTerms && (n.prop56 = I.indexTerms), n.currentVisitTime && (n.eVar31 = n.currentVisitTime, n.eVar31 && "0" != n.eVar31 || (n.eVar31 = "zero")), n.linkTrackVars = n.apl(n.linkTrackVars, "events", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "eVar24", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "eVar25", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "eVar31", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "prop11", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "prop31", ",", 2), n.linkTrackEvents = n.apl(n.linkTrackEvents, "prodView", ",", 2), n.linkTrackEvents = n.apl(n.linkTrackEvents, "event5", ",", 2), n.linkTrackEvents = n.apl(n.linkTrackEvents, "event40", ",", 2)
                                }
                            } else n.events = n.removeFromList("prodView,event5,event40,event29,event33,event30", ",", n.events, ",");
                            if (n.eVar21 && (n.events = n.apl(n.events, "event22", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "eVar21", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "events", ",", 2), n.linkTrackEvents = n.apl(n.linkTrackEvents, "event22", ",", 2)), n.prop23 && n.products)(I = pageDataTracker.getContentItem()) && I.id && (n.prop22 = I.id + ":" + n.prop23, n.linkTrackVars = n.apl(n.linkTrackVars, "prop22", ",", 2));
                            n.eVar60 && n.getValOnce(n.eVar60, "v60", 0) && (n.events = n.apl(n.events, "event75", ",", 2)), n.eVar61 && n.getValOnce(n.eVar61, "v61", 0) && (n.events = n.apl(n.events, "event76", ",", 2)), n.eVar15 && n.getValOnce(_satellite.getVar("Search - Criteria"), "e78", 0) && (n.events = n.apl(n.events, "event78", ",", 2), n.linkTrackEvents = n.apl(n.linkTrackEvents, "event78", ",", 2), e.eventData && eventData.search && (eventData.search.resultsPosition = "")), n.eVar37 && n.products && n.isTracked("eVar37") && (n.events = n.apl(n.events, "event44", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "events", ",", 2), n.linkTrackEvents = n.apl(n.linkTrackEvents, "event44", ",", 2));
                            var L = _satellite.getVar("Form - Step + Name"),
                                A = n.getValOnce(L, "fn", 0);
                            if (A && "login:start" === A) n.linkTrackVars = n.apl(n.linkTrackVars, "events", ",", 2), n.events = n.apl(n.events, "event141", ",", 2);
                            else if (A && "loginregistration:start" === A) n.linkTrackVars = n.apl(n.linkTrackVars, "events", ",", 2), n.events = n.apl(n.events, "event185", ",", 2);
                            else if (A && "termsagreement:start" === A) n.linkTrackVars = n.apl(n.linkTrackVars, "events", ",", 2), n.events = n.apl(n.events, "event186", ",", 2);
                            else if (A && "termsagreement:complete" === A) n.linkTrackVars = n.apl(n.linkTrackVars, "events", ",", 2), n.events = n.apl(n.events, "event187", ",", 2);
                            else if (A) {
                                b = "";
                                A.indexOf("complete") > -1 ? (b = "event" + (A.indexOf("register") > -1 || A.indexOf("registration") > -1 ? "2" : "47"), n.linkTrackVars = n.apl(n.linkTrackVars, "events", ",", 2), n.linkTrackVars = n.apl(n.linkTrackEvents, "prop2", ",", 2), n.linkTrackVars = n.apl(n.linkTrackEvents, "eVar4", ",", 2), n.linkTrackEvents = n.apl(n.linkTrackEvents, b, ",", 2)) : b = "event" + (A.indexOf("register") > -1 || A.indexOf("registration") > -1 ? "1" : "46"), n.events = n.apl(n.events, b, ",", 2)
                            } else n.events = n.removeFromList("event1,event2,event46,event47", ",", n.events, ",");
                            (L.indexOf("register") > -1 || L.indexOf("registration") > -1) && n.isTracked("eVar43") && (n.events = n.apl(n.events, "event216", ",", 2), n.linkTrackEvents = n.apl(n.linkTrackEvents, "event216", ",", 2)), t.location.href.length > 255 ? n.pageURL = t.location.href.substring(0, 255) : n.pageURL = t.location.href, n.campaign && -1 !== n.campaign.indexOf("raven") ? n.referrer = "mail://raven" : n.campaign && -1 !== n.campaign.indexOf("email") ? n.referrer = "mail://campaigns" : t.referrer && t.referrer.length > 255 && !n.referrer ? n.referrer = t.referrer.substring(0, 255) : t.referrer || (n.referrer = n.Util.getQueryParam("aaref")), n.prop8 && (n.linkTrackVars = n.apl(n.linkTrackVars, "prop8", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "eVar18", ",", 2)), n.eVar109 = n.getFullReferringDomains(), n.eVar109 && (n.linkTrackVars = n.apl(n.linkTrackVars, "eVar109", ",", 2)), n.eVar103 && (n.eVar110 = n.eVar110 ? n.eVar110 : "D=c19"), n.linkTrackVars = n.linkTrackVars || "", n.linkTrackVars = n.removeFromList("eVar118,eVar119,eVar120,eVar121,eVar144", ",", n.linkTrackVars, ","), e.eventData && eventData.link && eventData.link.location && (n.eVar118 = eventData.link.location, n.linkTrackVars = n.apl(n.linkTrackVars, "eVar118", ",", 2)), e.eventData && eventData.link && eventData.link.name && (n.eVar119 = eventData.link.name, n.linkTrackVars = n.apl(n.linkTrackVars, "eVar119", ",", 2)), e.eventData && eventData.link && eventData.link.type && (n.eVar120 = eventData.link.type, n.linkTrackVars = n.apl(n.linkTrackVars, "eVar120", ",", 2)), e.eventData && eventData.link && eventData.link.destination && (n.eVar121 = eventData.link.destination, n.linkTrackVars = n.apl(n.linkTrackVars, "eVar121", ",", 2)), e.eventData && eventData.link && eventData.link.userInputMethod && (n.eVar144 = eventData.link.userInputMethod, n.linkTrackVars = n.apl(n.linkTrackVars, "eVar144", ",", 2)), n.eVar103 && n.isTracked("eVar103") && (n.eVar145 = "D=v103", n.linkTrackVars = n.apl(n.linkTrackVars, "eVar145", ",", 2)), n.events && n.events.split(",").indexOf("event2") > -1 && (n.events = n.apl(n.events, "event7", ",", 2)), n.prop29 = n.eVar7 ? "D=v7" : "", n.eVar1 = n.prop21 ? "D=c21" : "", n.eVar2 = n.prop6 ? "D=c6" : "", n.eVar4 = n.prop2 ? "D=c2" : "", n.eVar5 = n.prop5 ? "D=c5" : "", n.eVar9 = n.prop16 ? "D=c16" : "", n.eVar10 = n.prop18 ? "D=c18" : "", n.eVar11 = n.pageName ? "D=pageName" : "", n.eVar13 = n.prop4 ? "D=c4" : "", n.eVar14 = n.purchaseID ? "D=purchaseID" : "", n.eVar16 = n.prop1 ? "D=c1" : "", n.eVar18 = n.prop8 ? "D=c8" : "", n.eVar26 = n.prop13 ? "D=c13" : "", n.eVar29 = n.prop12 ? "D=c12" : "", n.eVar32 = n.prop19 ? "D=c19" : "", n.eVar46 = n.prop7 ? "D=c7" : "", n.eVar101 = "D=g", n.list1 = n.prop7 ? "D=c7" : "", n.linkTrackVars = n.apl(n.linkTrackVars, "prop2", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "prop3", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "prop4", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "prop5", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "prop9", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "prop16", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "prop18", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "prop19", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "prop24", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "prop32", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "eVar4", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "eVar5", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "eVar8", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "eVar9", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "eVar10", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "eVar11", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "eVar13", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "eVar32", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "eVar50", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "eVar101", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "products", ",", 2), n.linkTrackVars = n.apl(n.linkTrackVars, "currencyCode", ",", 2), n.prop3 = n.getKPIName()
                        }
                    }, n.doPlugins = e.s_doPlugins;
                    try {
                        n.loadModule("Media"), n.Media.autoTrack = !1, n.Media.trackWhilePlaying = !1, n.Media.playerName = "elsevier video player", n.Media.segmentByMilestones = !0, n.Media.trackMilestones = "50", n.Media.trackUsingContextData = !0, n.Media.contextDataMapping = {
                        ...
                        }, n.Media.trackVars = "prop17,eVar52,eVar1,eVar2,eVar3", n.Media.trackEvents = "event66"
                    } catch (a) {}
                    n.isTracked = function(e) {
                        return -1 !== n.split(n.linkTrackVars, ",").indexOf(e)
                    }, n.getCustomReportSuites = function() {
                        if ("jb" == n.prop2) {
                            var a = "dev",
                                i = "";
                            if (e.pageData && pageData.page) {
                                var r = pageData.page.server || t.location.hostname,
                                    s = n.Util.getQueryParam("code");
                                a = null === t.location.hostname.match(/\-(qa|test|stag)/g) ? "prod" : "dev", "cell" == r || "www.cell.com" == r || "cell-site" == s ? ("ce", i = "cell") : "www.thelancet.com" == r || "lancet-site" == s ? ("lc", i = "the lancet") : ("ha", i = "other journal branded sites")
                            }
                            return n.channel = i, "elsevier-ha-" + a + ",elsevier-global-" + a
                        }
                        if (e.pageData && pageData.page && pageData.page.secondaryProductName) {
                            ...
                            a = "dev";
                            pageData.page.environment && (a = "prod" == pageData.page.environment || "cert" == pageData.page.environment ? pageData.page.environment : "dev");
                            for (var c = 0; c < o.length; c++)
                                if (pageData.page.secondaryProductName.toLowerCase() == o[c][0].toLowerCase()) return n.eVar107 = o[c][1], n.account + ",elsevier-" + o[c][1] + "-" + a;
                            return n.eVar107 = pageData.page.secondaryProductName.toLowerCase(), n.account
                        }
                        return n.account
                    }, n.removeFromList = function(e, t, n, a) {
                        t = t || ",", a = a || ",";
                        ...
                        for (var e = [{
                            ...
                            var i = new RegExp(e[a].event + "(,|$)", "g");
                            if (n.events.match(i)) {
                                for (var r = 0; r < e[a].products.length; r++) n.prop2.toLowerCase() == e[a].products[r].toLowerCase() && (t = e[a].name);
                                if (t) break
                            }
                        }
                        return t || ""
                    }, n.apl = new Function("l", "v", "d", "u", "var s=this,m=0;if(!l)l='';if(u){var i,n,a=l.split(d);for(i=0;i<a.length;i++){n=a[i];m=m||(u==1?(n==v):(n.toLowerCase()==v.toLowerCase()));}}if(!m)l=l?l+d+v:v;return l"), n.getValOnce = new Function("v", "c", "e", "var s=this,a=new Date,v=v?v:v='',c=c?c:c='s_gvo',e=e?e:0,k=s.c_r(c);if(v){a.setTime(a.getTime()+e*86400000);s.c_w(c,v,e?a:0);}return v==k?'':v"), n.getTimeParting = new Function("h", "z", "var s=this,od;od=new Date('1/1/2000');if(od.getDay()!=6||od.getMonth()!=0){return'Data Not Available';}else{var H,M,D,U,ds,de,tm,da=['Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday'],d=new Date();z=z?z:0;z=parseFloat(z);if(s._tpDST){var dso=s._tpDST[d.getFullYear()].split(/,/);ds=new Date(dso[0]+'/'+d.getFullYear());de=new Date(dso[1]+'/'+d.getFullYear());if(h=='n'&&d>ds&&d<de){z=z+1;}else if(h=='s'&&(d>de||d<ds)){z=z+1;}}d=d.getTime()+(d.getTimezoneOffset()*60000);d=new Date(d+(3600000*z));H=d.getHours();M=d.getMinutes();M=M<30?'00':'30';D=d.getDay();U=' AM';if(H>=12){U=' PM';H=H-12;}if(H==0){H=12;}D=da[D];tm=H+':'+M+U;return(tm+'|'+D);}"), n.getDaysSinceLastVisit = new Function("c", "var s=this,e=new Date(),es=new Date(),cval,cval_s,cval_ss,ct=e.getTime(),day=24*60*60*1000,f1,f2,f3,f4,f5;e.setTime(ct+3*365*day);es.setTime(ct+30*60*1000);f0='Cookies Not Supported';f1='First Visit';f2='More than 30 days';f3='More than 7 days';f4='Less than 7 days';f5='Less than 1 day';cval=s.c_r(c);if(cval.length==0){s.c_w(c,ct,e);s.c_w(c+'_s',f1,es);}else{var d=ct-cval;if(d>30*60*1000){if(d>30*day){s.c_w(c,ct,e);s.c_w(c+'_s',f2,es);}else if(d<30*day+1 && d>7*day){s.c_w(c,ct,e);s.c_w(c+'_s',f3,es);}else if(d<7*day+1 && d>day){s.c_w(c,ct,e);s.c_w(c+'_s',f4,es);}else if(d<day+1){s.c_w(c,ct,e);s.c_w(c+'_s',f5,es);}}else{s.c_w(c,ct,e);cval_ss=s.c_r(c+'_s');s.c_w(c+'_s',cval_ss,es);}}cval_s=s.c_r(c+'_s');if(cval_s.length==0) return f0;else if(cval_s!=f1&&cval_s!=f2&&cval_s!=f3&&cval_s!=f4&&cval_s!=f5) return '';else return cval_s;"), n.getPreviousValue = new Function("v", "c", "el", "var s=this,t=new Date,i,j,r='';t.setTime(t.getTime()+1800000);if(el){if(s.events){i=s.split(el,',');j=s.split(s.events,',');for(x in i){for(y in j){if(i[x]==j[y]){if(s.c_r(c)) r=s.c_r(c);v?s.c_w(c,v,t):s.c_w(c,'no value',t);return r}}}}}else{if(s.c_r(c)) r=s.c_r(c);v?s.c_w(c,v,t):s.c_w(c,'no value',t);return r}"), n.split = new Function("l", "d", "var i,x=0,a=new Array;while(l){i=l.indexOf(d);i=i>-1?i:l.length;a[x++]=l.substring(0,i);l=l.substring(i+d.length);}return a"), n.getPercentPageViewed = new Function("n", "var s=this,W=window,EL=W.addEventListener,AE=W.attachEvent,E=['load','unload','scroll','resize','zoom','keyup','mouseup','touchend','orientationchange','pan'];W.s_Obj=s;s_PPVid=(n=='-'?s.pageName:n)||s.pageName||location.href;if(!W.s_PPVevent){s.s_PPVg=function(n,r){var k='s_ppv',p=k+'l',c=s.c_r(n||r?k:p),a=c.indexOf(',')>-1?c.split(',',10):[''],l=a.length,i;a[0]=unescape(a[0]);r=r||(n&&n!=a[0])||0;a.length=10;if(typeof a[0]!='string')a[0]='';for(i=1;i<10;i++)a[i]=!r&&i<l?parseInt(a[i])||0:0;if(l<10||typeof a[9]!='string')a[9]='';if(r){s.c_w(p,c);s.c_w(k,'?')}return a};W.s_PPVevent=function(e){var W=window,D=document,B=D.body,E=D.documentElement,S=window.screen||0,Ho='offsetHeight',Hs='scrollHeight',Ts='scrollTop',Wc='clientWidth',Hc='clientHeight',C=100,M=Math,J='object',N='number',s=W.s_Obj||W.s||0;e=e&&typeof e==J?e.type||'':'';if(!e.indexOf('on'))e=e.substring(2);s_PPVi=W.s_PPVi||0;if(W.s_PPVt&&!e){clearTimeout(s_PPVt);s_PPVt=0;if(s_PPVi<2)s_PPVi++}if(typeof s==J){var h=M.max(B[Hs]||E[Hs],B[Ho]||E[Ho],B[Hc]||E[Hc]),X=W.innerWidth||E[Wc]||B[Wc]||0,Y=W.innerHeight||E[Hc]||B[Hc]||0,x=S?S.width:0,y=S?S.height:0,r=M.round(C*(W.devicePixelRatio||1))/C,b=(D.pageYOffset||E[Ts]||B[Ts]||0)+Y,p=h>0&&b>0?M.round(C*b/h):0,O=W.orientation,o=!isNaN(O)?M.abs(o)%180:Y>X?0:90,L=e=='load'||s_PPVi<1,a=s.s_PPVg(s_PPVid,L),V=function(i,v,f,n){i=parseInt(typeof a==J&&a.length>i?a[i]:'0')||0;v=typeof v!=N?i:v;v=f||v>i?v:i;return n?v:v>C?C:v<0?0:v};if(new RegExp('(iPod|iPad|iPhone)').exec(navigator.userAgent||'')&&o){o=x;x=y;y=o}o=o?'P':'L';a[9]=L?'':a[9].substring(0,1);s.c_w('s_ppv',escape(W.s_PPVid)+','+V(1,p,L)+','+(L||!V(2)?p:V(2))+','+V(3,b,L,1)+','+X+','+Y+','+x+','+y+','+r+','+a[9]+(a[9]==o?'':o))}if(!W.s_PPVt&&e!='unload')W.s_PPVt=setTimeout(W.s_PPVevent,333)};for(var f=W.s_PPVevent,i=0;i<E.length;i++)if(EL)EL(E[i],f,false);else if(AE)AE('on'+E[i],f);f()};var a=s.s_PPVg();return!n||n=='-'?a[1]:a"), n.p_fo = new Function("n", "var s=this;if(!s.__fo){s.__fo=new Object;}if(!s.__fo[n]){s.__fo[n]=new Object;return 1;}else {return 0;}"), n.clickPast = new Function("scp", "ct_ev", "cp_ev", "cpc", "var s=this,scp,ct_ev,cp_ev,cpc,ev,tct;if(s.p_fo(ct_ev)==1){if(!cpc){cpc='s_cpc';}ev=s.events?s.events+',':'';if(scp){s.events=ev+ct_ev;s.c_w(cpc,1,0);}else{if(s.c_r(cpc)>=1){s.events=ev+cp_ev;s.c_w(cpc,0,0);}}}"), n.__ccucr || (n.c_rr = n.c_r, n.__ccucr = !0, n.c_r = new Function("k", "var s=this,d=new Date,v=s.c_rr(k),c=s.c_rr('s_pers'),i,m,e;if(v)return v;k=s.escape(k);i=c.indexOf(' '+k+'=');c=i<0?s.c_rr('s_sess'):c;i=c.indexOf(' '+k+'=');m=i<0?i:c.indexOf('|',i);e=i<0?i:c.indexOf(';',i);m=m>0?m:e;v=i<0?'':s.unescape(c.substring(i+2+k.length,m<0?c.length:m));if(m>0&&m!=e)if(parseInt(c.substring(m+1,e<0?c.length:e))<d.getTime()){d.setTime(d.getTime()-60000);s.c_w(s.unescape(k),'',d);v='';}return v;")), n.__ccucw || (n.c_wr = n.c_w, n.__ccucw = !0, n.c_w = new Function("k", "v", "e", "var s=this,d=new Date(),ht=0,pn='s_pers',sn='s_sess',pc=0,sc=0,pv,sv,c,i,t;d.setTime(d.getTime()-60000);if(s.c_rr(k)) s.c_wr(k,'',d);k=s.escape(k);pv=s.c_rr(pn);i=pv.indexOf(' '+k+'=');if(i>-1){pv=pv.substring(0,i)+pv.substring(pv.indexOf(';',i)+1);pc=1;}sv=s.c_rr(sn);i=sv.indexOf(' '+k+'=');if(i>-1){sv=sv.substring(0,i)+sv.substring(sv.indexOf(';',i)+1);sc=1;}d=new Date;if(e){if(e.getTime()>d.getTime()){pv+=' '+k+'='+s.escape(v)+'|'+e.getTime()+';';pc=1;}}else{sv+=' '+k+'='+s.escape(v)+';';sc=1;}if(sc) s.c_wr(sn,sv,0);if(pc){t=pv;while(t&&t.indexOf(';')!=-1){var t1=parseInt(t.substring(t.indexOf('|')+1,t.indexOf(';')));t=t.substring(t.indexOf(';')+1);ht=ht<t1?t1:ht;}d.setTime(ht);s.c_wr(pn,pv,d);}return v==s.c_r(s.unescape(k));")), n.getFullReferringDomains = new Function("var s=this,dr=window.document.referrer,n=s.linkInternalFilters.split(',');if(dr){var r=dr.split('https://www.elsevier.com/')[2],l=n.length;for(i=0;i<=l;i++){if(r.indexOf(n[i])!=-1){r='';i=l+1;}}return r}")
                }
            },
        ...
        appVersion: "7QN",
        buildDate: "2018-11-21 09:40:52 UTC",
        publishDate: "2018-11-21 09:40:51 UTC"
    })
}(window, document);